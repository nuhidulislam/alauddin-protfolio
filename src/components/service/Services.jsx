...
const Services = () => {
  ...
  return (
    <div ref={ref} id="services" className=" h-auto pt-10 lg:min-h-screen md:px-14 px-8 py-8">
      ...
      <motion.h1 variants={fadeIn("right", "tween", 0.3, 0.5)} initial="hidden" whileInView="show" className=" text-xs md:text-base lg:text-xl pt-5 pb-10">
        I design and develop responsive, user-friendly web applications with a focus on 
modern frontend technologies. I specialize in building interactive websites, 
dynamic web pages, and seamless user experiences using React.js and Next.js.
      </motion.h1>
