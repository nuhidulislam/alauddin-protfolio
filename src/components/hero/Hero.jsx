  ...
  return (
    <div ref={ref} id="home" className=" h-auto py-24 lg:min-h-screen flex flex-col-reverse md:flex-row justify-center items-center md:px-14 px-8">
      ...
      <div className=" w-full md:w-[60%]">
        ...
        <motion.h1 variants={fadeIn("right", "tween", 0.5, 0.5)} initial="hidden" whileInView="show" className="text-4xl z-10 md:text-5xl lg:text-6xl font-outfit">Hi I&apos;m <br/> <span className=" text-softTheme font-bold">Md Alauddin</span></motion.h1>
        <motion.p variants={fadeIn("right", "tween", 0.7, 0.5)} initial="hidden" whileInView="show" className=" py-4 text-sm md:text-base capitalize font-poppins">I&apos;m a passionate MERN Stack Web Developer with expertise in React, Next.js, and modern frontend development.</motion.p>
        <motion.a variants={fadeIn("right", "tween", 0.9, 0.5)} initial="hidden" whileInView="show" href="#" target="_blank">
