  ...
  return (
    ...
    >
      <div ref={ref}>
        ...
        >
          A passionate Frontend Web Developer with expertise in React.js and Next.js, skilled in building dynamic and responsive web applications. Experienced in crafting modern user interfaces, optimizing performance, and delivering seamless user experiences with a strong focus on clean and intuitive design.
